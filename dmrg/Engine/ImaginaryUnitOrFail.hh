...
template <typename T> class ImginaryUnitOrFail {
public:
...
template <typename T> class ImginaryUnitOrFail<std::complex<T>> {
public:

	static std::complex<T> value() { return std::complex<T>(0., 1.); }
};
}
